...
output "helm_release_id" {
  ...
  value       = helm_release.mainwebsite.id
}
...
output "helm_chart_name" {
  ...
  value       = helm_release.mainwebsite.chart
}
...
output "helm_manifest" {
  ...
  value       = helm_release.mainwebsite.manifest
  sensitive   = true
}
...
output "kubernetes_namespace_uid" {
  ...
  value       = kubernetes_namespace.helm_namespace.metadata[0].uid
}
